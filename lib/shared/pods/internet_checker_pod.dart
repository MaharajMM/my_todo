...
final internetConnectionCheckerInstancePod = Provider.autoDispose<InternetConnection>((ref) {
...
class InternetStatusNotifier extends AutoDisposeStreamNotifier<InternetStatus> {
  ...
  Stream<InternetStatus> build() {
    ...
    if (enabled) {
      final statuschange = ref.watch(internetConnectionCheckerInstancePod).onStatusChange;
